...
Thirteen bundled cartridges ship in a roughly 292 KiB JAR. The runtime uses no
...
and [SHA-256 checksums](https://github.com/mulfyx/w4me-station/releases/download/v1.1.0/SHA256SUMS)
